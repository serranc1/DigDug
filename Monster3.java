...
public class Monster3 {
    ...
    public Monster3(int newy, int newx, int newtype, int newdirection) {
        y = newy;
        x = newx;
        facing = 1;
        type = newtype;
    ...
    public static void moveMonster(int[][] dirtmap, Monster3 monster) {
    ...
    public static void getInflated(int[][] dirtmap, Monster3 monster) {
    ...
    public static void breatheFire(int[][] dirtmap, Monster3 monster) {
        if(monster.facing == 1) {
    ...
    public static Monster3 identifyMonster(int y, int x, int[][] dirtmap) {
        Monster3 inflatingmonster;
            if(dirtmap[y][x] == 4) {
                inflatingmonster = Dirt.monster3;
                System.out.println("Monster3 identified");
            }
            else {
